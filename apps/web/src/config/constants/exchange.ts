...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BLAST_TESTNET]: [blastSepoliaTokens.usdt, blastSepoliaTokens.yantra],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.BLAST_TESTNET]: [blastSepoliaTokens.usdt, blastSepoliaTokens.weth],
}
...
// CAKE
export const DEFAULT_OUTPUT_CURRENCY = '0x8f3BeEf59556eA09483fE0224Dd062834969FBd0'

// Handler string is passed to Gelato to use PCS router
export const GELATO_HANDLER = 'pancakeswap'
export const GENERIC_GAS_LIMIT_ORDER_EXECUTION = 500000n

export const LIMIT_ORDERS_DOCS_URL = 'https://docs.yantra.exchange/products/pancakeswap-exchange/limit-orders'
