...
export const BLOCKS_CLIENT_BLAST = 'https://info.yantra.exchange/subgraphs/name/yantra/blocks'
export const STABLESWAP_SUBGRAPH_CLIENT = 'https://info.yantra.exchange/subgraphs/name/yantra/exchange-stableswap'
...
export const INFO_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.BLAST_TESTNET]: 'https://info.yantra.exchange/subgraphs/name/yantra/exchange-positions',
}
...
export const BLOCKS_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.BLAST_TESTNET]: BLOCKS_CLIENT_BLAST,
}

export const ASSET_CDN = 'https://yantra-assets.netlify.app'
...
export const V3_SUBGRAPH_URLS = {
  ...
  [ChainId.BLAST_TESTNET]: 'https://info.yantra.exchange/subgraphs/name/yantra/exchange-v3',
