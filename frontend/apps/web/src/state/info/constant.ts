...
export const multiChainName: Record<number | string, MultiChainNameExtend> = {
  ...
  [ChainId.BASE]: 'BASE',
  [ChainId.OPBNB]: 'OPBNB',
  [ChainId.BLAST_TESTNET]: 'BLAST_TESTNET',
}
...
export const multiChainBlocksClient: Record<MultiChainNameExtend, string> = {
  ...
  BLAST_TESTNET: BLOCKS_CLIENT_BLAST,
}
...
export const multiChainId: Record<MultiChainName, ChainId> = {
  ...
  BASE: ChainId.BASE,
  OPBNB: ChainId.OPBNB,
  BLAST_TESTNET: ChainId.BLAST_TESTNET,
}
...
export const multiChainQueryClient = {
  ...
  BLAST_TESTNET: v2Clients[ChainId.BLAST_TESTNET],
}
...
export const multiChainScan: Record<MultiChainName, string> = {
  ...
  BLAST_TESTNET: blastSepolia.blockExplorers.default.name,
}
...
export const ChainLinkSupportChains = [ChainId.BSC, ChainId.BSC_TESTNET, ChainId.BLAST_TESTNET]
