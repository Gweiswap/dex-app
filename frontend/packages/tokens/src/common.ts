...
export const YANTRA_TESTNET = new ERC20Token(
  ChainId.BLAST_TESTNET,
  '0x8f3BeEf59556eA09483fE0224Dd062834969FBd0',
  18,
  'YANTRA',
  'YANTRA Token',
  'https://yantra.exchange/',
)
...
export const YANTRA = {
  [ChainId.BLAST_TESTNET]: YANTRA_TESTNET,
}

export const DAI = {
  [ChainId.BLAST_TESTNET]: DAI_TESTNET,
}
...
export const STABLE_COIN = {
  ...
  [ChainId.BLAST_TESTNET]: USDT[ChainId.BLAST_TESTNET],
